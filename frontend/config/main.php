    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // 'sd-<category:\d+>-<k:.+>' => 'search/category',
                // 'sd-<category:\d+>-<k:.+>-<page:\d+>' => 'search/category',
                // 'sds-<category:\d+>-<k:.+>-<second:\w+>' => 'search/second',
                // 'sds-<category:\d+>-<k:.+>-<second:\w+>-<page:\d+>' => 'search/second',
            ],
        ],
    ],
    'params' => $params,
